...
class PublishMessageResponse extends BaseResponse
{
    ...
    public function parseErrorResponse($statusCode, $content, MnsException $exception = NULL)
    {
        ...
        try {
            ...
            {
                throw new TopicNotExistException($statusCode, $result['mobile_code_dayu'], $exception, $result['Code'], $result['RequestId'], $result['HostId']);
            }
            ...
            {
                throw new MalformedXMLException($statusCode, $result['mobile_code_dayu'], $exception, $result['Code'], $result['RequestId'], $result['HostId']);
            }
