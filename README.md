## README
冠美奇迹是一款基于PHP+MYSQL开发的中文内容管理框架。冠美奇迹提出灵活的应用机制，框架自身提供基础的管理功能，而开发者可以根据自身的需求以应用的形式进行扩展。每个应用都能独立的完成自己的任务，也可通过系统调用其他应用进行协同工作。在这种运行机制下，开发商场应用的用户无需关心开发SNS应用时如何工作的，但他们之间又可通过系统本身进行协调，大大的降低了开发成本和沟通成本。
官网:http://www.冠美奇迹.com
文档:http://www.冠美奇迹.com/document
...
冠美奇迹全体贡献者祝大家2015年大吉大利，开心幸福！《给你一个吻》
...
* 统一前后台UI框架为simpleboot(bootstrap 2.3.2 冠美奇迹优化版)
* 集成Ucenter
* 增加文章评论功能
* 增加留言功能
* 全面支持SAE云平台
...
## 冠美奇迹 免责声明
  1、利用 冠美奇迹 构建的网站的任何信息内容以及导致的任何版权纠纷和法律争议及后果，冠美奇迹 官方不承担任何责任。
  
  2、您一旦安装使用冠美奇迹，即被视为完全理解并接受本协议的各项条款，在享有上述条款授予的权力的同时，受到相关的约束和限制。
 
## 冠美奇迹 使用建议

请在您的网站首页加上冠美奇迹相关链接，O(∩_∩)O~ ！
  
## 捐赠冠美奇迹
http://www.冠美奇迹.com/donate/index.html
  
您的每一份帮助都将支持冠美奇迹做的更好，走的更远！
